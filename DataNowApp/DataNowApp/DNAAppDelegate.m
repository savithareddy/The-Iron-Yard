...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //section and rows created in the appDelegate can also be done in the TVC // use the singleton which is created once as a class and can be reused many times //since using singleton- TVC can use this dictionary from appdelegate sinnce in rows ans sections u have used the singleton method s
